				...
				<div className='row'>
					...
					<div className='col-3'>
						<label>
							<input type='text' name='nom' />
							<p>
								Si pas héberger: liste d’attente (depuis le
								jj/mm/aa) + à la rue ?
							</p>
						</label>
					</div>
				...
				<div className='row'>
					...
					<div className='col-3'>
						<label>
							<input type='text' name='prenom' />
							<p>
								Date d’obtention de la PI ( Deux types de
								protections : Le statut de réfugié et la
				...
				<div className='row'>
					...
					<div className='col-3'>
						<label>
							<input type='text' name='prenom' />
							<p>
								Numéro ADGREF C’est le numéro d’étranger de10
								chiffres qui figure sur le titre de séjour
							</p>
						</label>
					</div>
					<div className='row'>
